...
// small helper to build the HTML string that detail.ejs expects
...
// DB-backed detail by ID (Task 1)
router.get("/detail/:invId", (req, res, next) => {
  try {
    return invController.buildDetail(req, res, next)
  } catch (e) { next(e) }
})

// Intentional 500 route (Task 3)
